...
but do not stop the import.`,
  ...
  se-prices-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  se-prices-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | se-prices-pp-cli import <resource> --input -`,
