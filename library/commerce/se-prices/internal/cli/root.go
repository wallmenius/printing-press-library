...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "se-prices-pp-cli",
		Short: `Se Prices CLI — Combined CLI for Prisjakt and PriceRunner with cross-site arbitrage, price-drop digests, and EAN-keyed lookups no singl…`,
		Long: `Se Prices CLI — Combined CLI for Prisjakt and PriceRunner with cross-site arbitrage, price-drop digests, and EAN-keyed lookups no singl…
...
Health check: run 'se-prices-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("se-prices-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'se-prices-pp-cli profile list')")
	...
	rootCmd.AddCommand(newPricerunnerCmd(flags))
	rootCmd.AddCommand(newPrisjaktCmd(flags))
	// Hand-authored novel transcendence commands (cross-site combo)
	rootCmd.AddCommand(newLowestCmd(flags))
	rootCmd.AddCommand(newEANCmd(flags))
	rootCmd.AddCommand(newArbitrageCmd(flags))
	rootCmd.AddCommand(newCatalogueDiffCmd(flags))
	rootCmd.AddCommand(newDropsCmd(flags))
	rootCmd.AddCommand(newWatchlistCmd(flags))
	rootCmd.AddCommand(newHistoryComboCmd(flags))
	rootCmd.AddCommand(newIsSaleCmd(flags))
	...
	rootCmd.AddCommand(newSepSyncCmd(flags))
