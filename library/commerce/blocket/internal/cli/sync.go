...
Exit codes & warnings:
  ...
  blocket-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  blocket-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  blocket-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  blocket-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  blocket-pp-cli sync --latest-only`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if dbPath == "" {
				dbPath = defaultDBPath("blocket-pp-cli")
			}
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/blocket-pp-cli/data.db)")
...
func defaultSyncResources() []string {
	return []string{
		...
		"cars",
		"mobility",
		"mobility-search-api-search-search-id-agriculture-threshing",
		"mobility-search-api-search-search-id-agriculture-tool",
		"mobility-search-api-search-search-id-agriculture-tractor",
		"mobility-search-api-search-search-id-car-a-tractor",
		"mobility-search-api-search-search-id-car-agri",
		"mobility-search-api-search-search-id-car-bus",
		"mobility-search-api-search-search-id-car-caravan",
		"mobility-search-api-search-search-id-car-mobile-home",
		"mobility-search-api-search-search-id-car-truck",
		"mobility-search-api-search-search-id-mc-scooter",
		"motorcycles",
	}
}
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		...
		"mobility": "/mobility/search/api/search/SEARCH_ID_MC_ATV",
		"mobility-search-api-search-search-id-agriculture-threshing": "/mobility/search/api/search/SEARCH_ID_AGRICULTURE_THRESHING",
		"mobility-search-api-search-search-id-agriculture-tool":      "/mobility/search/api/search/SEARCH_ID_AGRICULTURE_TOOL",
		"mobility-search-api-search-search-id-agriculture-tractor":   "/mobility/search/api/search/SEARCH_ID_AGRICULTURE_TRACTOR",
		"mobility-search-api-search-search-id-car-a-tractor":         "/mobility/search/api/search/SEARCH_ID_CAR_A_TRACTOR",
		"mobility-search-api-search-search-id-car-agri":              "/mobility/search/api/search/SEARCH_ID_CAR_AGRI",
		"mobility-search-api-search-search-id-car-bus":               "/mobility/search/api/search/SEARCH_ID_CAR_BUS",
		"mobility-search-api-search-search-id-car-caravan":           "/mobility/search/api/search/SEARCH_ID_CAR_CARAVAN",
		"mobility-search-api-search-search-id-car-mobile-home":       "/mobility/search/api/search/SEARCH_ID_CAR_MOBILE_HOME",
		"mobility-search-api-search-search-id-car-truck":             "/mobility/search/api/search/SEARCH_ID_CAR_TRUCK",
		"mobility-search-api-search-search-id-mc-scooter":            "/mobility/search/api/search/SEARCH_ID_MC_SCOOTER",
