...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  blocket-pp-cli workflow archive

  # Full re-archive (ignore previous sync state)
  blocket-pp-cli workflow archive --full`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resources := []string{"ads", "boats", "cars", "mobility", "mobility-search-api-search-search-id-agriculture-threshing", "mobility-search-api-search-search-id-agriculture-tool", "mobility-search-api-search-search-id-agriculture-tractor", "mobility-search-api-search-search-id-car-a-tractor", "mobility-search-api-search-search-id-car-agri", "mobility-search-api-search-search-id-car-bus", "mobility-search-api-search-search-id-car-caravan", "mobility-search-api-search-search-id-car-mobile-home", "mobility-search-api-search-search-id-car-truck", "mobility-search-api-search-search-id-mc-scooter", "motorcycles"}
			totalSynced := 0
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  blocket-pp-cli workflow status

  # Show status as JSON
  blocket-pp-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("blocket-pp-cli")
			}
